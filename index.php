...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <meta name="description" content="produccion musical ">

        <meta name="author" content="sysarteck">

        <title>Chey production</title>
    ...
    <body id="body">
        ...
        <section id="home">	    
                        ...
                        <div class="sl-slide-inner">
                            ...
                            <div class="carousel-caption">
                                <div>
                                    ...
                                    <h2 data-wow-duration="500ms"  data-wow-delay="500ms" class="heading animated fadeInRight">Chey production</h2>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="audio-player">
                ...
                <audio id="audio-player" src="audio/bob marley.mp3" type="audio/mp3" controls="controls"></audio>
